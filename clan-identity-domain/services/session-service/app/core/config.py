...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = "Session Service"
    ...
    POSTGRES_DB: str = os.getenv("POSTGRES_DB", "session_service")
    ...
    JWT_SECRET_KEY: str = os.getenv("JWT_SECRET_KEY", "session-service-secret-key")
